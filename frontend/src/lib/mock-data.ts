...
export const mockFixedDeposits: FixedDeposit[] = [
  {
    ...
    interest_payout_freq: null, auto_renew: false, funded_externally: true, notes: null,
  ...
  },
  {
    ...
    interest_payout_freq: null, auto_renew: true, funded_externally: true, notes: null,
    status: "active", closure_date: null, closure_amount: null,
    tags: [{ id: 2, name: "Debt", color: "#10B981" }],
